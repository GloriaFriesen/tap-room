...
export class NewKegComponent {
  ...
  submitForm(name: string, brewery: string, type: string, price: number, alcoholContent: string) {
    var newKegToAdd: Keg = new Keg(name, brewery, type, price.toFixed(2), alcoholContent);
